...
def main(test_path, weight_path, save_performance, show_detection):
    ...
    global RETRAINED_LABELS_TXT_FILE_LOC
    RETRAINED_LABELS_TXT_FILE_LOC = weight_path + "/" + "retrained_labels.txt"
    global RETRAINED_GRAPH_PB_FILE_LOC
    RETRAINED_GRAPH_PB_FILE_LOC = weight_path + "/" + "retrained_graph.pb"

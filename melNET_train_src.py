...
MODEL_DIR = os.getcwd() + "/Accessories/" + "Model"
...
#######################################################################################################################
def main(train_dir, weight_dir, learning_rate, batch_size, iteration):

    # Passing Values:
    # path to folders of labeled images
    global TRAINING_IMAGES_DIR
    ...
    global OUTPUT_GRAPH
    OUTPUT_GRAPH = weight_dir + '/retrained_graph.pb'

    # where to save the intermediate graphs
    global INTERMEDIATE_OUTPUT_GRAPHS_DIR
    INTERMEDIATE_OUTPUT_GRAPHS_DIR = weight_dir + "/intermediate_graph"

    # where to save the trained graph's labels
    global OUTPUT_LABELS
    OUTPUT_LABELS = weight_dir + '/retrained_labels.txt'

    # where to save summary logs for TensorBoard
    global TENSORBOARD_DIR
    TENSORBOARD_DIR = weight_dir + '/tensorboard_logs'

    # Path to cache bottleneck layer values as files
    global BOTTLENECK_DIR
    BOTTLENECK_DIR = weight_dir + '/Bottleneck_data'
